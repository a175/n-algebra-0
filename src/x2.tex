...
\Crefname{Example}{Example}{Examples}
\crefname{nonexample}{Example}{Examples}
...
\newcommand{\commatospace}[1]{\@for\mytoken:=#1\do{\,\mytoken\,}}
\makeatother
...
\newcommand{\Shazo}[4]{\begin{array}{ccc}\displaystyle #1&\longrightarrow&\displaystyle #2\\[-0.4ex]\upin&&\upin\\[0ex]\textstyle #3&\longmapsto&\textstyle #4\end{array}}
