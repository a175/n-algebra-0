...
一点集合$\star$から$Y$への写像を
$0$項演算と呼ぶことがある.
一点集合$\star$から$Y$への写像は,
...
\begin{definition}
  次の条件を満たすとき,
  $e\in X$は$\ast$に関し左単位的であるという:
  \begin{enumerate}
    \item $x\in X\implies e\ast x=x$.
  \end{enumerate}
  次の条件を満たすとき,
  $e\in X$は$\ast$に関し右単位的であるという:
  \begin{enumerate}
...
\begin{remark}
  ...
  $\ast$が和と呼ばれるときには, $\ast$の単位元は零元とよばれ$0$や$O$にまつわる記号が用いられることが多く,
  $\ast$が和と呼ばれるときには, $\ast$の単位元は$1$や$E$, $I$にまつわる記号が用いられることが多いように思う.
\end{remark}
\begin{cor}
  右単位元と左単位元が存在するなら,
  それらは一致し$\ast$の単位元である,
